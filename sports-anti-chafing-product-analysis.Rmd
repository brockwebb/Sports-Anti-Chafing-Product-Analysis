...
# And a list of the running products:
...
We'll need to compare the ratings of both bike and run to see if one is rated signifigantly higher or lower. Then we can also use "water" as a treatment effect.
